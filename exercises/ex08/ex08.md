...
GLib is a library that provides a set of data structures and utility functions
for C programs. Yes, it is confusing that GLib and glibc are two separate things.

*  What are the most important pros and cons of using GLib, as opposed
to another library, or just using core C features?

GLib provides higher-level functions that can make writing a program easier.
It also allows you to import data structures, which have been tested and used
on many projects.
