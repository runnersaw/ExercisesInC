...
Output:
```
svaughan@ubuntu:~/Documents/ExercisesInC/exercises/ex12$ time ./counter
19079757 errors.

real	0m2.184s
user	0m3.340s
sys	0m0.104s
svaughan@ubuntu:~/Documents/ExercisesInC/exercises/ex12$ time ./counter_mutex
0 errors.
...
The synchronized code takes about 5 times as long as the unsyncronized version, although it does result in 0 errors as opposed to 19 million.
